...
<body id="top">
    ...
    <div class="page-content">
        <div class="div">
            <div class="ww-home-page" id="home">
                <div class="ww-wedding-announcement d-flex align-items-center justify-content-start">
                    <div class="container ww-announcement-container">
                        <p class="ww-couple-name ww-title" data-aos="zoom-in-down" data-aos-delay="300" data-aos-duration="1000"></p><img class="img-fluid mt-2" data-aos="zoom-in-down" src="images/title-gold.png" data-aos-delay="300" data-aos-duration="1000" />
            ...
            <div class="ww-section" id="couple" style="background-image: url(images/bg1-gold.png); ">
                <div class="container">
                    <center>
                        <br><br>
                        <img src="images/pawiwahan-gold.png" data-aos="zoom-in-down" data-aos-duration="1000" style="height: 150px; width: 150px;">
                        <br><br>
                    </center>
                    <div class="row text-center ">
                        <div class="col-md-6">
                            <div class="mt-3"><img class="img-fluid" style="border-radius: 50%; width: 300px; height: 300px;" src="images/p-22.png" alt="Groom" data-aos="flip-left" data-aos-duration="1000" />
                        ...
                        <div class="col-md-6">
                            <div class="mt-3"><img class="img-fluid" style="border-radius: 50%; width: 300px; height: 300px;" src="images/p-11.png" alt="Bride" data-aos="flip-right" data-aos-duration="1000" />
                                <p class="pt-3 text-left text-muted"></p>
            ...
            <div class="ww-section" style="background-color:#fff7e0;">
                <div class="container ww-wedding-event" id="invite">
                    <br><br>
                    <center>
                        <img src="images/undangan-gold.png" data-aos="zoom-in-down" data-aos-duration="1000" style="height: 150px; width: 150px;">
                        <br><br>
                    </center>
                    <center>
                    ...
                    <center>
                        ...
                        <br><br>
                        <img src="images/split.png" style="height: 150px; width: 300px;">

                    </center>
                </div>
            </div>

            <div class="ww-section bg-light" id="gallery" style="background-image: url(images/bg1-gold.png); ">
                <div class="ww-photo-gallery">
                    <div class="container">
                        <center>
                            <br><br>
                            <img src="images/gallery-gold.png" data-aos="zoom-in-down" data-aos-duration="1000" style="height: 150px; width: 150px;">
                            <br><br>
                            <div>
                        ...
                        <div class="ww-gallery" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-duration="1000" data-aos-offset="0">
                            <div class="card-columns">
                                <div class="card" data-groups="[&quot;vacation&quot;,&quot;ceremony&quot;]"><a href="images/g-1.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-1.jpg" alt="w1" /></a></div>
                                <div class="card" data-groups="[&quot;party&quot;,&quot;wedding&quot;]"><a href="images/g-2.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-2.jpg" alt="u" /></a></div>
                                <div class="card" data-groups="[&quot;vacation&quot;]"><a href="images/g-3.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-3.jpg" alt="t" /></a></div>
                                <div class="card" data-groups="[&quot;party&quot;,&quot;vacation&quot;]"><a href="images/g-4.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-4.jpg" alt="Gallery Pic 4" /></a></div>
                                <div class="card" data-groups="[&quot;wedding&quot;,&quot;ceremony&quot;,&quot;party&quot;]"><a href="images/g-5.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-5.jpg" alt="Gallery Pic 6" /></a></div>
                                <div class="card" data-groups="[&quot;vacation&quot;]"><a href="images/g-6.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-6.jpg" alt="Gallery Pic 7" /></a></div>
                                <div class="card" data-groups="[&quot;wedding&quot;,&quot;party&quot;]"><a href="images/g-7.jpg" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="images/g-7.jpg" alt="Gallery Pic 8" /></a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <center>
                <div id="messageList" class="message-list " style="background-image: url(images/bg1-gold.png); ">
                    <center>
                        <?php
            ...
            <div class="loc" id="loc">
                <br><br>
                <center>
                    <img src="images/lokasi-gold.png" data-aos="zoom-in-down" data-aos-duration="1000" style="height: 150px; width: 150px;">
                </center>
                <br><br>
                <center>
